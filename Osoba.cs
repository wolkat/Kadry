...
namespace Kadry
{
    class Adres {
        ...
        public void ZmienAdres() {
            Console.Write("Podaj nazwe miejscowosci: ");
    ...
    class Osoba
    {
        ...
        public Osoba(int numerEwidencyjny, string imie, string nazwisko, Adres adres) :
            this(numerEwidencyjny, imie, nazwisko, adres.ZwrocNumerDomu(), adres.ZwrocNumerMieszkania(), adres.ZwrocNazwaUlicy(), adres.ZwrocKod(), adres.ZwrocMiejscowosc()) { }
